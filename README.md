...
- **Everything 搜索（可选）**：配置 es.exe 后在悬浮窗直接搜全盘，智能排序把目标目录置顶
- **观感**：明暗主题热切换（跟随系统 / 手动）、Windows 原生文件类型图标、中英界面、Win11 风格轻量卡片
...
之后弹文件对话框时，悬浮窗右上角会出现搜索框：输入即搜（智能重排，目录优先 / 精确命中 / 浅路径置顶）、**↑/↓** 选行、**Enter** 跳选中项（无选中取第一条）、**Esc** 清空恢复列表。未配置则不显示。
